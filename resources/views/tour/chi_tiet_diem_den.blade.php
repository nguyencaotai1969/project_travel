	...
	<div class="container detail-des">
		...
		<div class="row text-left text-xs-center text-md-left" id="des-detail">
			...
			<div class="detail col-md-7 ml-auto">
				<p>Vịnh Hạ Long nơi rồng đáp xuống, là danh thắng quốc gia được xếp hạng từ năm 1962. Hạ Long có 1.969 hòn đảo, lô nhô trên mặt biển, nổi tiếng nhất là các hòn Lư Hương, Gà Chọi, Cánh Buồm, Mâm Xôi, đảo Ngọc Vừng, Ti Tốp, Tuần Châu. Hạ Long như bức tranh thủy mặc khổng lồ, tuyệt đẹp, xứng đáng là biểu tượng du lịch Việt Nam.</p>
			...
			<div class="col-lg-9 col-md-12" id="tour-list">
				...
				<div class="tour row">
					...
					<div class="info col-md-8">
						<h5><a href="#"><b>Tour du lịch Hà Nội – Hạ Long 2 ngày 1 đêm – Du ngoạn cảnh đẹp kì quan thiên nhiên thế giới</b></a></h5>
						<div class="row">
