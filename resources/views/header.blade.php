<nav class="navbar navbar-expand-md fixed-top top-nav">
    <div class="container">
          <a class="navbar-brand" href="{{route('trangchu')}}"><img src="{{asset('img/logo.png')}}"width="100" height="37" alt=""></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item ">
                <a class="nav-link dangnhap" href="{{route('login')}}"><i class="fas fa-sign-in-alt"></i>&nbsp;Đăng Nhập</a>
              </li>
            </ul>
          </div>    
    </div>  
