    ...
    <div class="row">
        ...
        <div class="new-arrival">
            ...
            <div class="titlebar">
                ...
                <div class="next-back">
                    <span>
                        <a data-slide="prev" href="#Carousel" class="left carousel-control"><img src="http://www.sclance.com/pngs/back-button-png/back_button_png_77116.png" width="20" alt="">
                        </a>
                    </span>
                    <span>
                        <a data-slide="next" href="#Carousel" class="right carousel-control"><img src="http://pluspng.com/img-png/next-button-png-open-2000.png" width="20" alt="">
                        </a>
                    </span>
                </div>
            </div>
...
<div class="container">
    ...
    <!-- Category Card -->
    <div class="col-md-4 col-xs-12 col-sm-12 p2">
        <div class="card rounded">
            <div class="card-image zoom">
                <span class="card-notify-badge">2 ngày 3 đêm</span>
                <span class="card-notify-year">50%</span>
                <img class="img-fluid" src="https://travel.com.vn/Images/LastMinute/lm_190911075159_562321.jpg" alt="Alternate Text" />
            </div>
    ...
    <div class="col-md-4 col-xs-12 col-sm-12 p-2">
        <div class="card rounded">
            <div class="card-image">
                ...
                <img class="img-fluid" src="https://travel.com.vn/Images/tour/tfd_180228011522_625701.jpg" alt="Alternate Text" />
            </div>
            <div class="card-image-overlay m-auto">
                <span class="card-detail-badge">28,000,000đ</span>
                <span class="card-detail-badge khuyenmai-giamgia"><Strike>2,000,000đ</Strike></span>
    ...
    <div class="col-md-4 col-xs-12 col-sm-12 p-2">
        <div class="card rounded">
            <div class="card-image">
                ...
                <img class="img-fluid" src="https://travel.com.vn/Images/LastMinute/lm_190913095923_067292.jpg" alt="Alternate Text" />
            </div>
            <div class="card-image-overlay m-auto">
    ...
    <ul class="row">
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight">
            <figure>
              <img src="https://dulichviet.com.vn/images/bandidau/images/NOI-DIA/du-lich-trong-nuoc-hanh-trinh-di-san-mien-trung-2017.png" class="img-responsive" alt="">
            </figure>
...
<div class="container">
   ...
   <section class="customer-logos-ourcarosel slider">
      ...
      <div class="slide"><img src="https://thietkelogodeponlinetructuyen.files.wordpress.com/2016/12/logo-htv.png?w=1400"></div>
      <div class="slide"><img src="https://upload.wikimedia.org/wikipedia/vi/7/79/BIDV_Logo.png"></div>
      <div class="slide"><img src="https://brandslogo.net/wp-content/uploads/2018/04/Bamboo-Airways-logo-vector.png"></div>
